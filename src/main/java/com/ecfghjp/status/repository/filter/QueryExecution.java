...
public class QueryExecution implements Specification<Status>{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private List<SearchCriterea> list;
	...
	public void add(SearchCriterea criteria) {
		list.add(criteria);
	}
	...
	public Predicate toPredicate(Root<Status> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
		...
		for (SearchCriterea criteria : list) {
