package com.ecfghjp.status.exception;
 ...
 * Global Exception Handler for Employees Exceptions class handling exceptions and relaying back with a customized message
 *
 */
@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleTrainingNotFoundException(EmployeeNotFoundException ex) {
